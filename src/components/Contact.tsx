...
const Contact: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/mario26rgl',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/mario26rgl',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/mario26rgl',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      name: 'Email',
      url: 'mailto:mario26rgl@example.com',
      icon: (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:mario26rgl@example.com" 
                    className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                  >
                    mario26rgl@example.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-12 h-12 bg-gray-200 dark:bg-gray-700 hover:bg-primary-600 dark:hover:bg-primary-600 text-gray-600 dark:text-gray-300 hover:text-white rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
